...
namespace VirtualStand
{
    public partial class NewElement : Form
    {
        ...
        private Panel AddPanel()
        {
            ...
            p.Size = new Size(pLines.Width - 10, height);
            p.BackColor = panels.Count % 2 == 0 ? Color.AliceBlue : Color.Aqua;
            p.AutoScroll = true;
            panels.Add(p);
        ...
        //клин на панели для изображений
        ...
        private void bSave_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                writer.WriteStartElement("element", tbName.Text);
                if (background != null)
                {
                ...
                foreach(DataGridViewRow dgvr in dgvIn.Rows)
                    if(dgvr.Cells["NameIn"].Value != null)
                    {
                        ...
                        writer.WriteAttributeString("xmlns", dgvr.Cells["NameIn"].Value.ToString());
